...
function ProtectedDashboard() {
  ...
  return <DashboardLayout user={user}><Routes><Route index element={user.role === 'patient' ? <DashboardHome /> : <ProfessionalHome role={user.role} />} /><Route path="appointments" element={<Appointments />} /><Route path="records" element={<Records />} /><Route path="reminders" element={<Reminders />} /><Route path="assistant" element={<Assistant />} /><Route path="patients" element={<HelpPage title="Patient directory" />} /><Route path="prescriptions" element={<HelpPage title="Prescriptions" />} /><Route path="users" element={<HelpPage title="User management" />} /><Route path="analytics" element={<ProfessionalHome role="admin" />} /><Route path="help" element={<HelpPage />} /><Route path="notifications" element={<HelpPage title="Notifications" />} /></Routes></DashboardLayout>
}
