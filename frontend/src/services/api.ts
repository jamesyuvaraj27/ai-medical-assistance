...
export type SessionUser = { id: string; name: string; email: string; role: 'patient' | 'doctor' | 'admin'; specialty?: string; createdAt?: string }
export type Doctor = SessionUser
export type Appointment = { id: string; patientId: string | { _id: string; name: string; email: string }; doctorId: string | { _id: string; name: string; email: string; specialty?: string }; date: string; slot: string; status: 'scheduled' | 'cancelled' | 'completed'; notes?: string }
...
export type NotificationItem = { id: string; userId?: string; title: string; message?: string; body?: string; type: 'appointment' | 'medication' | 'system' | string; read?: boolean; createdAt: string }
...
export const api = {
  ...
  doctorPatients: () => request<{ patients: PatientSummary[] }>('/patients'),
  users: () => request<{ users: UserSummary[] }>('/users'),
  adminUsers: () => request<{ users: UserSummary[] }>('/users'),
